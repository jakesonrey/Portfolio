...
<template>
  <MainLayout :pageTitle="pageTitle">
    <section>
<body class="bg-cyan-400 text-gray-100 px-8 py-12">
      <div class="text-center w-full">
        <h1 class="text-4xl lg:text-5xl font-bold text-black font-serif leading-tight">Get in touch with me!</h1>
      </div>
      <div
        ...
        <div class="">
          ...
          <div class="mt-8">
            <button
              class="uppercase text-sm font-bold tracking-wide bg-cyan-400 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
